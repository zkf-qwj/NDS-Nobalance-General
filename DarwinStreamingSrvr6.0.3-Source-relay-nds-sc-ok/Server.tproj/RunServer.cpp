...
QTSS_ServerState StartServer(XMLPrefsParser* inPrefsSource, PrefsSource* inMessagesSource, UInt16 inPortOverride, int statsUpdateInterval, QTSS_ServerState inInitialState, Bool16 inDontFork, UInt32 debugLevel, UInt32 debugOptions)
{
	...
	qtss_printf("<----------------------------Read Me--------------------------------------->\n");
	qtss_printf("* 1.general darwin nobalance\n");
	qtss_printf("* 3.transport_mode 是根据机顶盒的User Agent 来判断的,xml文件中配置User Agent的集合\n");
	qtss_printf("* 3.四川省网和市网的盒子都支持\n");
	qtss_printf("<------------------------------End----------------------------------------->\n");
   ...
   //ARTS::LicenseMgr_v1::instance()->enableExpiryPoll("arts-rtsp-server", "1.0"); 
   ...
   sARTS_License_thread = new ARTS_License_thread();
    ...
    qtss_printf("Entering startServer....\n");
    //start the server
...
{   
    ...
    qtss_printf("Entering RunServer....\n");
