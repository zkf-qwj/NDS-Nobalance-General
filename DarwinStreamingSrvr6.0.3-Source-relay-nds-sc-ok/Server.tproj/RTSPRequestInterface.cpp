...
/*
extern Bool16 g_iswasu;
extern Bool16 g_isjinshan;
extern Bool16 g_isningxia;
*/
...
//zlj add 20161208 offset struct 
		...
		StrPtrLen* ssrc,StrPtrLen* inSessionID)
{
	...
	//qtss_printf("zlj IsWasu= %x,IsNingxia= %x,IsJinshan= %x\n",g_iswasu,g_isningxia,g_isjinshan); 
	//zlj add 20161208
	qtss_printf("transportmode:%d\n",GetTransportUserAgentMode());	
	...
	if (g_iswasu == true || g_isningxia == true){
		qtss_printf("zlj this is wasu\n");
